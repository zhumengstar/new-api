...
const XiaomiMiMoIcon = ({ size = 14, style = {}, ...props }) => (
  <svg
    fill='currentColor'
    fillRule='evenodd'
    height={size}
  ...
  >
    ...
    <path d='M.958 15.936a.459.459 0 01.459.44v2.729a.46.46 0 01-.918 0v-2.729a.459.459 0 01.459-.44zm4.814-2.035a.46.46 0 01.553.45v4.754a.458.458 0 11-.918 0V15.48L3.74 17.202a.462.462 0 01-.655.016.462.462 0 01-.065-.082L.628 14.67a.459.459 0 01.658-.637l2.124 2.187 2.127-2.188a.46.46 0 01.235-.13zm2.068.004a.46.46 0 01.458.445v4.755a.46.46 0 01-.458.458.459.459 0 01-.458-.458V14.35a.459.459 0 01.458-.445zm1.973 2.014a.46.46 0 01.46.457v2.729a.46.46 0 01-.784.324.46.46 0 01-.134-.324v-2.729a.46.46 0 01.458-.458zm.002-2.045a.458.458 0 01.328.157l2.127 2.19 2.125-2.19a.459.459 0 01.784.318v4.756a.46.46 0 01-.455.458.46.46 0 01-.458-.458V15.48l-1.667 1.723a.46.46 0 01-.656.017.46.46 0 01-.019-.018l-2.438-2.512a.458.458 0 01.329-.816zm6.884 4.065a.46.46 0 01.458.44v.727a.459.459 0 01-.459.458.457.457 0 01-.458-.458v-.727a.459.459 0 01.459-.44zm3.072-2.033a.46.46 0 01.459.445v2.755a.46.46 0 01-.918 0v-2.755a.459.459 0 01.459-.445zm2.68-.004a.46.46 0 01.49.085l.04.04.009.01.991 1.023c.085.09.13.209.13.329v.01a.459.459 0 01-.459.455h-2.065a.459.459 0 01-.457-.459.46.46 0 01.457-.458h.982l-.31-.319a.46.46 0 01.194-.752zm-1.18-3.475a.459.459 0 01.457.458v1.265l2.045-2.045a.46.46 0 01.648.648l-2.835 2.834a.46.46 0 01-.783-.325v-2.183a.46.46 0 01.458-.458zm-1.5-.002a.46.46 0 01.459.458v1.636a.459.459 0 11-.918 0v-1.636a.459.459 0 01.459-.458z' />
  </svg>
);
...
export function getLobeHubIcon(iconName, size = 14) {
  ...
  if (iconName === 'XiaomiMiMo' || iconName === 'XiaomiMiMo.Color') {
