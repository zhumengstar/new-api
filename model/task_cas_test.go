...
func TestMain(m *testing.M) {
	...
	if err := db.AutoMigrate(
		...
		&ModelRequestDailyStat{},
		&ModelRequestStatsCheckpoint{},
		&Redemption{},
		&SubscriptionPlan{},
		&SubscriptionOrder{},
		&UserSubscription{},
...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		DB.Exec("DELETE FROM user_virtual_quotas")
		...
		DB.Exec("DELETE FROM user_consumption_daily_stats")
		DB.Exec("DELETE FROM model_request_daily_stats")
		DB.Exec("DELETE FROM model_request_stats_checkpoints")
